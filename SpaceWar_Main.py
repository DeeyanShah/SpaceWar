...
class Login:
        def __init__(self,root):
                ...
                submit = Button(Frame_login, command=self.check_function, cursor="hand2", text="Submit", bd = 0, font=("Goudy old style", 15), bg="#6162FF", fg="white").place(x=90,y=360, width=180, height=40)
        ...
        def check_function(self):
            ...
            while True:
                ...
                if self.username.get()=="" or self.password.get() == "":
                        ...
                        class chooseGame:
                                def __init__(self,root2):
                                        ...
                                        self.username2 = Entry(Frame_login2, font=("Goudy old style", 15), bg="#E7E6E6")
                                        self.username2.place(x=90, y=178, width=320, height=35)
                                        ...
                                        submit2 = Button(Frame_login2, command=self.check_function2, cursor="hand2", text="Submit", bd = 0, font=("Goudy old style", 15), bg="#6162FF", fg="white").place(x=90,y=360, width=180, height=40)

                                def check_function2(self):
                                        ...
                                        while True:
                                                ...
                                                #1
                                                if self.username2.get()=="":
                                                        messagebox.showerror("Error", "All Fields are Required",parent=self.root)
                                                        break
                                                    

                                                elif self.username2.get()=="Pong":
                                                         #messagebox.showinfo("Welcome!")
                                                         #break
                                                         root.destroy()
                                                         window = turtle.Screen()
                                                         window.title("Ping-Pong by Deeyan Shah and Zach Consoli")
                                                        ...
                                                        wn.title("Space Arena! By Deeyan and Zach")
                                                        wn.bgcolor("black")
                                                        ...
                                                        character_pen.draw_string(pen, "BY DEEYAN AND ZACH", 0, 100)
                ...
                elif self.username.get() == "Snake Game":
